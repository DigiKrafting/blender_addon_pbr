...
class ds_pbr_nodes_remove(bpy.types.Operator):
...
class ds_pbr_auto_textures(bpy.types.Operator):
...
class ds_pbr_nodes_auto(bpy.types.Operator):
...
class ds_pbr_nodes(bpy.types.Operator):
...
class ds_pbr_material_options(bpy.types.PropertyGroup):
...
classes = (
    ds_pbr_render_cycles,
    ds_pbr_render_eevee,
    ds_pbr_texture_select,
    ds_pbr_texture_select_clr,
    ds_pbr_textures_path_select,
    ds_pbr_textures_path_select_clr,
    ds_pbr_material_options,
    ds_pbr_nodes_remove,
...
def register():
    ...
    bpy.types.Material.ds_pbr_material_options = bpy.props.PointerProperty(type=ds_pbr_material_options)
